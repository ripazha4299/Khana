			...
			<div class="col-md-7 service-bottom animated wow fadeInRight" data-wow-duration="1000ms" data-wow-delay="500ms">
				<div class=" service-bottom1">
					<div class=" ser-bottom">
						<img src="images/An.jpg" class="img-responsive" alt="">
					</div>
					<div class="ser-top "> 
						<h5>Antik Chowdhury</h5>
						<p><font color="black">antikc683@gmail.com</font></p>
					</div>
					<div class="clearfix"> </div>
				</div>
                <div class=" service-bottom1">
					...
					<div class="ser-top "> 
						<h5>Shradha Jaiswal</h5>
						<p><font color="black">shradhajaiswal26@gmail.com</p>
					</div>
					<div class="clearfix"> </div>
				</div>
                <div class=" service-bottom1">
					<div class=" ser-bottom">
						<img src="images/sn.jpg" class="img-responsive" alt="">
					</div>
					<div class="ser-top "> 
						<h5>Subhraneel Das</h5>
						<p><font color="black">neelnyou@gmail.com</p>
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class=" service-bottom1">
					<div class=" ser-bottom">
						<img src="images/ah.jpg" class="img-responsive" alt="">
					</div>
					<div class="ser-top "> 
						<h5>Aheli Mandal</h5>
						<p><font color="black">aheli.mandal8981@gmail.com</p>
					</div>
					<div class="clearfix"> </div>
				</div>
			</div>
