	...
	<div class="contact">
		...
		<div class="menu-top">
				<div class="col-md-4 menu-left animated wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="500ms">
					<h3>Sign in</h3>
					<label><span class="auto-style1"><a href="LogIn.aspx">Signed in already? Log in here</a></span></label></div>
			...
			<h5>New User Sign in</h5>
				...
				<div class="grid-contact">
					...
					<div class="col-md-6 contact-grid">
						...
						<input type="text" value="" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='';}" runat="server" id="email"/>
					</div>
					<div class="col-md-6 contact-grid">
                    ...
                    <div class="col-md-6 contact-grid">
						<p class="your-para" style="width: 21%">Confirm Password</p>
						<input type="Password" value="" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='';}" runat="server" id="confirmpassword"/>
					</div>
					<div class="clearfix"> </div>
				</div>
				&nbsp;<div class="send">
						&nbsp;<asp:Button ID="log_in" runat="server" OnClick="log_in_Click" Text="Sign In" />
					    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT email FROM customer_details where email=@e">
                            <SelectParameters>
